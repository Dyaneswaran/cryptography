...
public class DES{
	...
	static String hexToBin(String hex, int n){
		hex  = (hex.length() < n ? new String(new char[n - hex.length()]).replace('\0','0') : "") + hex;
		String bin = "";                                                                                                        for(int i = 0; i < hex.length(); ++i)                                                                                           switch(hex.charAt(i)){                                                                                                          case '0': bin += "0000"; break;                                                                                         case '1': bin += "0001"; break;                                                                                         case '2': bin += "0010"; break;                                                                                         case '3': bin += "0011"; break;                                                                                         case '4': bin += "0100"; break;                                                                                         case '5': bin += "0101"; break;                                                                                         case '6': bin += "0110"; break;                                                                                         case '7': bin += "0111"; break;                                                                                         case '8': bin += "1000"; break;                                                                                         case '9': bin += "1001"; break;                                                                                         case 'a': case 'A': bin += "1010"; break;                                                                               case 'b': case 'B': bin += "1011"; break;                                                                               case 'c': case 'C': bin += "1100"; break;                                                                               case 'd': case 'D': bin += "1101"; break;                                                                               case 'e': case 'E': bin += "1110"; break;                                                                               case 'f': case 'F': bin += "1111"; break;                                                                       }                                                                                                               return bin;                                                                                        
	}
	...
	static BigInteger[] generateKeys(String key){
		...
		for(int i = 0; i < 16; ++i){
			...
			String roundKey = hexToBin(C.toString(16), 7) + hexToBin(D.toString(16), 7);
			String roundKey_PC2 = "";
	...
	static String encrypt(String plaintext, BigInteger[] roundkeys, boolean decrypt){
		...
		int padLength = (hexString.length() % 16 == 0 ? 0 : 16 - hexString.length() % 16);
	...
	static BigInteger feistel(BigInteger r, BigInteger key){
		//Expansion.
		String R32B = hexToBin(r.toString(16), 8), expandedR = "";
		for(int i = 0; i < 48; ++i)
			expandedR += R32B.charAt(E[i] - 1);

		//XOR Operation.
		String xorR_K = hexToBin(key.xor(new BigInteger(expandedR, 2)).toString(16), 12);
